...
main()
{
	...
	# run docker
	docker run -ti --rm -v ${StudyFolder}:/dataset -v ${outputdir}:/output hcp/preflighttest /dataset /output -subjID ${SUBJ} -dataset DEPRESSION --license_key ${LICENSE} --n_cpus 8 --stages ${STAGES}
